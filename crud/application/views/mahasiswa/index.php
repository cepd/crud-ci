        ...
        <div class="container-xl">
            <div class="table-responsive">
                <div class="table-wrapper">
                        ...
                        <tbody>
                            <tr>
                                ...
                                if( ! empty($mahasiswa)){
                                    ...
                                    <td>".$data->jurusan."</td>
                                    <td>
                                        <a href='".base_url("mahasiswa/ubah/".$data->nim)."'>Ubah</a>
                                        <a href='".base_url("mahasiswa/hapus/".$data->nim)."'>Hapus</a>
                                    </td>
                                    </tr>";
                                    }
                                }else{
                    ...
                    <div class="clearfix">
                        <div class="hint-text">Menampilkan <b>2</b> dari <b>2</b> data</div>
                        <ul class="pagination">
                ...
                <div class="modal-content">
                    <form method="post" action="<?php echo base_url("mahasiswa/tambah"); ?>">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>Kontak</label>
                                <input type="text" class="form-control" name="input_kontak" value="<?php echo set_value('input_kontak'); ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
